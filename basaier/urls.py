...
urlpatterns += i18n_patterns(
    ...
    path('science-center-news/<int:id>/detail',
         views.ScienceCenterDetail.as_view(),
         name='science-center-news-detail'),
    ...
    path('volunteer/', views.Volunteer.as_view(), name='volunteer'),
    path('partner/', views.Partner.as_view(), name='partner'),
    ...
    path('masjid/<int:projectId>', views.masjid, name="masjid"),
