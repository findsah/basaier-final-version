...
urlpatterns += i18n_patterns(
    ...
    path('privateProject/<int:id>/detail',
         views.privateProjectDetail.as_view(), name='project-detail-private'),
    path('openPdf/<int:id>',
    ...
    path('changePassword/', views.ChangePasswordView.as_view(),
         name='changePassword'),
    path('testimonials', views.aboutUs, name='testimonials'),
    ...
    path('FAQs/', views.volunteerNew, name='volunteer'),
