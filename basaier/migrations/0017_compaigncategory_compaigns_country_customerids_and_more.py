    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('compaignCategory', models.ManyToManyField(to='basaier.compaigncategory')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='basaier.category')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('compaignId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='basaier.compaigns')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='country', to='basaier.country')),
            ],
        ),
        migrations.CreateModel(
            name='SMS',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ManyToManyField(to='basaier.sponsorship')),
            ],
            options={
        ...
        migrations.AlterField(
            model_name='project',
            name='category',
            field=models.ManyToManyField(to='basaier.category'),
        ),
        ...
        migrations.AddField(
            model_name='sms',
            name='transaction',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='basaier.transaction'),
        ),
        migrations.AddField(
            model_name='sacrifice',
            name='project',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='project', to='basaier.project'),
        ),
        migrations.AddField(
            model_name='donatesponsor',
            name='project',
            field=models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='donation', to='basaier.sponsorshipprojects'),
        ),
        migrations.AddField(
            model_name='donatesponsor',
            name='sacrifice',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sacrifices', to='basaier.sacrifice'),
        ),
        migrations.AddField(
            model_name='donatesponsor',
            name='sponsorCategory',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='basaier.sponsorship'),
        ),
        migrations.AddField(
            model_name='donatesponsor',
            name='sponsorProject',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='basaier.sponsorshipprojects'),
        ),
        migrations.AddField(
            model_name='donatesponsor',
            name='transaction',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='transactions', to='basaier.transaction'),
        ),
        migrations.AddField(
            model_name='donatesponsor',
            name='user',
        ...
        migrations.AddField(
            model_name='donate',
            name='project',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='donations', to='basaier.project'),
        ),
        migrations.AddField(
            model_name='donate',
            name='sacrifice',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sacrifice', to='basaier.sacrifice'),
        ),
        migrations.AddField(
            model_name='donate',
            name='transaction',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='transaction', to='basaier.transaction'),
        ),
        migrations.AddField(
            model_name='donate',
            name='user',
