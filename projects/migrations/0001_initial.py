# Generated by Django 2.2.17 on 2022-04-10 08:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phoneNumber1', models.CharField(blank=True, max_length=255, null=True)),
                ('phoneNumber2', models.CharField(blank=True, max_length=255, null=True)),
                ('phoneNumber3', models.CharField(blank=True, max_length=255, null=True)),
                ('email', models.CharField(blank=True, max_length=255, null=True)),
                ('website', models.CharField(blank=True, max_length=255, null=True)),
                ('facebookLink', models.CharField(blank=True, max_length=255, null=True)),
                ('twitterLink', models.CharField(blank=True, max_length=255, null=True)),
                ('instagramLink', models.CharField(blank=True, max_length=255, null=True)),
                ('yearFounded', models.CharField(blank=True, max_length=255, null=True)),
                ('affliatedAuthority', models.CharField(blank=True, max_length=255, null=True)),
                ('branches', models.CharField(blank=True, max_length=255, null=True)),
                ('natureOfEntityWork', models.CharField(blank=True, max_length=255, null=True)),
                ('employeesInEntity', models.CharField(blank=True, max_length=255, null=True)),
                ('projectsImplemented', models.CharField(blank=True, max_length=255, null=True)),
                ('prominentGoals', models.CharField(blank=True, max_length=255, null=True)),
                ('achievements', models.CharField(blank=True, max_length=255, null=True)),
                ('beneficiarySegments', models.CharField(blank=True, max_length=255, null=True)),
                ('entityManagerName', models.CharField(blank=True, max_length=255, null=True)),
                ('entityManagerPhoneNumber1', models.CharField(blank=True, max_length=255, null=True)),
                ('entityManagerUsername1', models.CharField(blank=True, max_length=255, null=True)),
                ('entityManagerPhoneNumber2', models.CharField(blank=True, max_length=255, null=True)),
                ('entityManagerUsername2', models.CharField(blank=True, max_length=255, null=True)),
                ('entityManagerPhoneNumber3', models.CharField(blank=True, max_length=255, null=True)),
                ('entityManagerUsername3', models.CharField(blank=True, max_length=255, null=True)),
                ('entityManagerPhoneNumber4', models.CharField(blank=True, max_length=255, null=True)),
                ('donorName', models.CharField(blank=True, max_length=255, null=True)),
                ('theState1', models.CharField(blank=True, max_length=255, null=True)),
                ('donorName2', models.CharField(blank=True, max_length=255, null=True)),
                ('theState2', models.CharField(blank=True, max_length=255, null=True)),
                ('donorName3', models.CharField(blank=True, max_length=255, null=True)),
                ('theState3', models.CharField(blank=True, max_length=255, null=True)),
                ('donorName4', models.CharField(blank=True, max_length=255, null=True)),
                ('theState4', models.CharField(blank=True, max_length=255, null=True)),
                ('nameOfSponsoringParty', models.CharField(blank=True, max_length=255, null=True)),
                ('attachTestimonial', models.FileField(blank=True, null=True, upload_to='bePartner/%Y/%m/%d')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('projectCategory', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='projects.Project')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(blank=True, null=True, upload_to='moreThanOnePdfFiles')),
                ('projectCategory', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='projects.Project')),
            ],
            options={
                'verbose_name': 'Multiple PDF Files',
                'verbose_name_plural': 'Multiple PDF Files',
            },
        ),
        migrations.CreateModel(
            name='PostImage',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('generatedLink', models.CharField(blank=True, max_length=255)),
                ('project', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='projects.Project')),
            ],
            options={
